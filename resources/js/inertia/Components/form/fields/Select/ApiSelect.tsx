                        ...
                        <div
                            ...
                            ${
                                include(getOption(item), selected)
                                    ? `${styles?.selectedDropDownItemClasses ?? "bg-primary border-primary"}`
                                    : ""
                            }
                            ${styles?.dropDownItemClasses ?? "cursor-pointer hover:border-primary hover:bg-primary my-1 p-2 rounded-md w-full text-black"}`}
