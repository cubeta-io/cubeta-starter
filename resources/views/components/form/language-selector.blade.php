<div class="row">
    <div class="col-md-12 d-flex justify-content-center align-items-center lang-btn-holder">
        @foreach (config('cubeta-starter.available_locales') as $lang)
            <input type="radio" class="btn-check lang-btn" name="selected-language" id="lang-{{ $lang }}" autocomplete="off"
