...
class CubetaStarterServiceProvider extends PackageServiceProvider
{
    ...
    private function publishWeb(): void
    {
        $this->publishes([
            ...
            __DIR__ . "/../src/Contracts/Repositories/IBaseRepository.stub"       => app_path("Repositories/Contracts/IBaseRepository.php"),
            __DIR__ . "/../src/Contracts/Services/BaseService.stub"               => app_path("Services/Contracts/BaseService.php"),
            __DIR__ . "/../src/Contracts/Services/IBaseService.stub"              => app_path("Services/Contracts/IBaseService.php"),
