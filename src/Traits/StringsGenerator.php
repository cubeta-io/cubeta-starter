...
trait StringsGenerator
{
    ...
    public function hasManyFunction(CubeTable|CubeRelation $model): string
    {
        ...
        return "public function $relationName()\n{\n\t return \$this->hasMany(" . $model->relationModel . "::class);\n}\n\n";
    }
    ...
    {
        $relationName = $model->relationMethodNaming(singular: false);
        return "public function $relationName()\n{\n\t return \$this->belongsToMany(" . $model->relationModel . "::class , '$pivot');\n}\n\n";
    }
    ...
    public function belongsToFunction(CubeTable|CubeRelation $model): string
    {
        ...
        return "public function $relationName()\n{\n\t return \$this->belongsTo(" . $model->relationModel . "::class); \n}\n\n";
    }
    ...
    {
        $functionName = 'with' . ucfirst(Str::plural(Str::studly($model->relationModel)));
        return "public function {$functionName}(\$count = 1)\n{\n\t return \$this->has(\\" . config('cubeta-starter.model_namespace') . "\\{$model->relationModel}::factory(\$count));\n} \n";
    }
